import type { CardMainStyle } from "../../../types/card.js";
...
const getHomePageCardProps = (cardType: string, width: number): HomePageCardProps => {
  ...
  let fontSize = width >= 1400 ? 10 : width >= 1200 ? 9 : width >= 900 ? 7.5 : width >= 700 ? 6.5 : 5.5;
  return {
    showFront: true,
    type: cardType,
