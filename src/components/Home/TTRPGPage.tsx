...
interface TTRPGPageProps {
  videoModalVisible: boolean;
  setVideoModalVisible: (visible: boolean) => void;
}

export default function TTRPGPage({ videoModalVisible, setVideoModalVisible }: TTRPGPageProps) {
  ...
  return (
    <div className="content">
      ...
      <HeroImageSection
        videoModalVisible={videoModalVisible}
        playVideo={playVideo}
        titleOverride={"An entire tabletop RPG in just 12 minutes!"}
      />
