const allCharacters = [
  {
    ...
    japaneseRace: "オーク",
    japaneseDescription: [
      "幼い頃他のオーク達より小さくて、いじめられっ子でいつも一人ぼっちだったウルグ。ダークウェブで自分 みたいなのけ者達と交わって育ちました。",
      "オークへの評判を改善したくて番組に出演したウルグは優しいオークもいると知らせたいつつ、自分の違法の趣味が漏れないかと心配だ。",
    ],
    japaneseHobbies: [
      "大手の会社からハッキングでお金を盗んでいろんなチャリティーに寄付すること",
      "ダークネットのクリプトカレンシーで資金洗浄",
      "NFT（偽造不可な鑑定書・所有証明書付きのデジタルデータ）のマーケットプレイスを管理し、面白いオークをベースにしたNFTが好き",
    ],
    japaneseEmployer: "アメージングEコマース",
    japaneseJob: "Webデザイナー",
    japaneseName: "ハッカーのウルグ",
    image: {
      url: "/images/members/characters1.webp",
      name: "characters1.webp",
      width: 2000,
      height: 1200,
  ...
  },
  {
    ...
    japaneseRace: "コカトリス",
    japaneseDescription: [
      "伝説によると、コカトリスは一目で人間を殺せると言われている。それが本当か試したくもないベアトリスはいつも特別なデザイナーサングラスを着けている。安心して鏡を見れるようにコカトリス専用のレンズを開発中",
      "イギリス生まれ、そして育ち。腕はないが嘴と足だけでも十分器用だ。自分の親のことは全く知らないが、伝説によると、コカトリスは雄鶏の卵が蛇に孵されたら生まれると言われている。",
    ],
    japaneseHobbies: [
      "ヴィーガンに憧れているがたまにはお肉を食べっちゃう",
      "いろんなデザインのサングラスを試着するのが好き",
      "様々な言語の文字が好き",
    ],
    japaneseEmployer: "カヴェンディッシュ眼科クリニック",
    japaneseJob: "検眼医",
    japaneseName: "ベアトリス・カヴェンディッシュ",
    image: {
      url: "/images/members/characters2.webp",
      name: "characters2.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "30%",
  ...
  },
  {
    ...
    japaneseRace: "エルフ",
    japaneseDescription: [
      "日本系のエルフ。普通のエルフみたいに物理的な成長はもう止まっているが、心の成長の先はまだ遥かに遠い。さらに刺激的な何かを求め、村から都心へと引っ越した。",
      "地元のエルフ達と同じように消防士を目指している。恋愛経験が一度もないことで周りの友達にいつもからかわれる。",
    ],
    japaneseHobbies: [
      "ギター",
      "スケートボード",
    ...
    japaneseEmployer: false,
    japaneseJob: "消防士志望",
    japaneseName: "小坊士",
    image: {
      url: "/images/members/characters3.webp",
      name: "characters3.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "70%",
  ...
  },
  {
    ...
    japaneseRace: "ドラゴン",
    japaneseDescription: [
      "ドラゴンの成年年齢は役１００歳くらいだ。ドラゴンは自分の体を自由自在に子猫のように小さくも、４階建物のように大きくも操られる。サイズの操作はかなりのエネルギーと体力が要る。",
      "猫のように怠惰なコトルはいつも寝ている。仕事のない暇な時は、たまに軽い運動で自分の尻尾を追いかける。「仕事をするために生きている」派より「生きるために仕事をしている」派らしく、仕事好きのものとはあまり仲良くなれない。",
    ],
    japaneseHobbies: ["寝ること", "睡眠を取ること", "仮眠"],
    japaneseEmployer: "ドラゴン宅配便",
    japaneseJob: "配送員",
    japaneseName: "不機嫌のコトル",
    image: {
      url: "/images/members/characters4.webp",
      name: "characters4.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "left",
  ...
  },
  {
    ...
    hobbies: [
      ...
      "Making mocktails with exotic ingredients. Non-alcoholic only.",
      "Fitness. Particularly bodyweight exercises like yoga or pilates.",
    ],
    japaneseRace: "人間",
    japaneseDescription: [
      "ミズモニア魔術アカデミーでポーションとミクソロジー専攻の２年生、リディア。魔法の飲み物でいろんな人や獣に役立ちたいと自信満々な子。",
      "両腕に魔法のルーン文字とタトゥーをいれている。一般の魔術師の帽子よりバケツハットが好き。タトゥーを塞ぐ長袖は苦手。",
    ],
    japaneseHobbies: [
      "読書、特に人間しか存在しない異世界のSFジャンル",
      "知られてない不思議な材料でモクテルを作ること",
    ],
    japaneseEmployer: "ミズモニア魔術アカデミー",
    japaneseJob: "学生",
    japaneseName: "リディア・グリムズベイン",
    image: {
      url: "/images/members/characters5.webp",
      name: "characters5.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
  ...
  },
  {
    ...
    japaneseRace: "バシリスク",
    japaneseDescription: [
      "伝説によるとバシリスクの毒は嗅ぐだけで昏睡に落とすくらい非常に致命的な毒だと言われている。その毒は裏マーケットややみ市場では非常に高く売れている。",
      "バシリスクへ評判はあまり良くないが、アッシは自分の毒で新しい抗毒素を開発している。バシリスクのイメージを改善するため番組に出演したのだ。",
    ],
    japaneseHobbies: [
      "クロスフィット",
      "ポールダンス",
    ...
    japaneseEmployer: "サーペント研究センター",
    japaneseJob: "検査技師",
    japaneseName: "アッシ・ラーニー",
    image: {
      url: "/images/members/characters6.webp",
      name: "characters6.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "60%",
  ...
  },
  {
    ...
    hobbies: [
      ...
      "Wearing colors that clash against his bluish skin. Despite it making him stick out like a sore thumb when going bird watching.",
      "Yelling loudly.",
    ],
    japaneseRace: "オーガ",
    japaneseDescription: [
      "左手はガキの頃不良者達との付き合いでなくしてしまった。それ以来、例の連中と縁を切ったが、何回か元どおりに落ちかけたことはある。その度左手のことを思い出すために傷の上にタトゥーを入れる。",
      "ちょっと頭悪げなやつだけと、とても親切で善意の人だ。会ったばかりの誰にも、長く知り合った人にも、彼はみんなに愛されている。",
    ],
    japaneseHobbies: [
      "体が大きすぎてこっそり近づくのが苦手だが探鳥が大好き",
      "自分の青い肌に目立つ服を着るのが好き。探鳥には悪影響を及ぼすが",
      "大声で叫ぶのが大好き",
    ],
    japaneseEmployer: "近所のクラブやバー",
    japaneseJob: "クラブの用心棒",
    japaneseName: "オガルク・チェストモール",
    image: {
      url: "/images/members/characters7.webp",
      name: "characters7.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "right",
  ...
  },
  {
    ...
    hobbies: [
      "Shopping for clothes and haggling for a good deal.",
      "Going to the spa and getting a massage.",
      "Hiking and nature trails. Nothing too strenuous though.",
      "Religiously keeping her skin moisturized and looking flawless.",
    ],
    japaneseRace: "ダークエルフ",
    japaneseDescription: [
      "赤ん坊の時、親に捨てられ、アンナは森の中で農家の人間に見つけれて育った。人間の文明最中に育ったせいで人間の価値観を持っているが、いつも違和感を抱いていた。平均身長より高く、周りの子と変わった肌の色のせいで彼女は村のどこでも際立った。",
      "他のダークエルフを探すため大都市に引っ越し、モデルになったアンナは自分の親のことをずっと探していた。最後の手段として番組に出たらしい。",
    ],
    japaneseHobbies: ["値切るのが好き", "お得な購入", "マッサージ、スパ"],
    japaneseEmployer: "ファッション雑誌MONST",
    japaneseJob: "モデル",
    japaneseName: "アンナ・サラドリア・ウェスターガード",
    image: {
      url: "/images/members/characters8.webp",
      name: "characters8.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "75%",
  ...
  },
  {
    ...
    japaneseRace: "ドワーフ",
    japaneseDescription: [
      "アルコール大好きのボトルガード家の末っ子。自分より３・４倍大きい獣よりもぐっと酒を飲める。バーにはいつも一番最初に入って、一番最後に追い出されるやつだ。",
      "ビール、ワイン問わずアルコールならなんでも好き。仕事上がりはいつも近所のバーで呑みすぎで倒れる癖がある。帰宅もせず仕事先で呑み倒れて発見されることもある。",
    ],
    japaneseHobbies: [
      "お酒を呑むのが好き",
      "金がけの飲みで勝つのも好き",
    ...
    japaneseEmployer: "トレガロンドワーフ自動車",
    japaneseJob: "整備士",
    japaneseName: "コレリン・ボトルガード",
    image: {
      url: "/images/members/characters9.webp",
      name: "characters11.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "35%",
  ...
  },
  {
    ...
    japaneseRace: "モノポッド",
    japaneseDescription: [
      "モノポッドの足は一つしかないがかなり早い獣だ。その上に、脚の重さのせいで重心がかなり低いためバランスがすごく安定的。飛ぶ時は脚を前に出し、回っていく重力で前に進む速度が意外と早い。",
      "美脚モデルのロサムンドは大きい獣用の靴や靴下を履く。番組に出た理由は、靴下や靴の片方を履いてくれる相手を探すためだそうだ。",
    ],
    japaneseHobbies: [
      "コスプレ。特に一足でも出来るクリエティブなコスチュームが好き。例えばランプ、フーズボールの選手など",
      "靴の買い物",
    ],
    japaneseEmployer: "BIG雑誌",
    japaneseJob: "美脚モデル",
    japaneseName: "ロザムンド・ガルバッシー",
    image: {
      url: "/images/members/characters10.webp",
      name: "characters10.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "65%",
  ...
  },
  {
    ...
    japaneseRace: "生き人形",
    japaneseDescription: [
      "ストリングズワース家は長い歴史ある魔術師に魔法をかけられ生き返った人形達。その魔術師の正体は未だに謎のまま。家門の伝説によると魔術師はタバコ用の木管をいつも口にしたと言われているそうだ。",
      "食べ物と水も要らない存在で、ロビンは太らず痩せず生きられる。歳も取らない木の人形で、ストリングズワース家は食事代わり木用の透明ワニスを塗るらしい。",
    ],
    japaneseHobbies: [
      "ゴスロリコスプレ",
      "服を変えて着ること",
      "いろんな時代からのファッショングッズを試着すること",
    ],
    japaneseEmployer: "ラ・クリアダ・カフェ",
    japaneseJob: "メードカフェの店員",
    japaneseName: "ロビン・ストリングズワース",
    image: {
      url: "/images/members/characters11.webp",
      name: "characters11.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
  ...
  },
  {
    ...
    japaneseRace: "ノーム",
    japaneseDescription: [
      "ワドルゼドルという面白い苗字を持つドルピップは自分がコメディアンをやるべきだと思っていたが、エンジニアや開発者の家族達は彼のことを兄弟中の屑だと思っている。",
      "常に突っ込まなくてはいけない使命感を持っているドルピップは、たまに空気を読めずしんとさせてしまう。コメディーショーのためにガーデンノーム（庭小人）の服装を着る。",
    ],
    japaneseHobbies: [
      "何があっても周りのみんなを笑わせること、自分もネタにする場合もある",
      "コメディで冷たい空気を変えること",
      "屁をネタにすること",
    ],
    japaneseEmployer: false,
    ...
    image: {
      url: "/images/members/characters12.webp",
      name: "characters12.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "42.5%",
  ...
  },
  {
    ...
    japaneseDescription: [
      "腐らないよう常に自分の体を変えなくてはならない。クッキーから出来た新しい腕や脚を買って入れ替える。シュガーラッシュが特に大好き。いつも鼻の下は砂糖のせいでほんの少し白く見えている。時々緊急時、自分の手足や体の一部を食べることも好き。",
      "伝説によるとジンジャーブレッド人はお菓子作りが好きな魔女によって作られたと言われている。",
    ],
    japaneseHobbies: [
      "バイト先から甘いもの盗みこむこと",
      "映画館、特に残されたお菓子とドリンク",
    ...
    japaneseEmployer: "6-Tenコンビニ",
    japaneseJob: "コンビニフリーター",
    japaneseName: "ジンジャーナッツ・グイハグ",
    image: {
      url: "/images/members/characters13.webp",
      name: "characters13.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "75%",
  ...
  },
  {
    ...
    japaneseRace: "ゴブリン",
    japaneseDescription: [
      "ゴブリンの成年年齢は役８歳くらい。ゴブリンの苗字は普段自分の出来事や快挙によって作られている。特に経済系と詐欺の快挙に因んでいる。",
      "ビズはどんな状況でも常にボウタイをつけている。人とのソフトスキルも数字や算数も得意。どんな複雑な計算でも計算機は要らない。物覚えがよく、人の誕生日をたった一回聞いて何年経っても忘れない。",
    ],
    japaneseHobbies: [
      "微積分",
      "ナンパ動画をみること",
    ...
    japaneseEmployer: "新クレストヒル銀行",
    japaneseJob: "銀行家",
    japaneseName: "ビズ・ハグルフィート",
    image: {
      url: "/images/members/characters14.webp",
      name: "characters14.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
    },
  ...
  },
  {
    ...
    japaneseRace: "ワイバーン",
    japaneseDescription: [
      "ワイバーンの成年年齢は役６０歳だ。ワイバーンはドラゴンと違って脚は２つしかない。飛ぶにはかなり多くのエネルギーが必要で、常に空腹状態であるグロドットはいつも何かを食べている。",
      "フランスで料理学校卒業。ワイバーンはドラゴンと違って火を口から出せないが、グロドットはスモークやこげ物の料理が専門。自分の料理を世界中に知らせたいと夢を抱いている。",
    ],
    japaneseHobbies: [
      "SNS映え用の食べ物の写真",
      "飛び込んでびっくりさせること",
    ...
    japaneseEmployer: "ルッフ食店",
    japaneseJob: "シェフ",
    japaneseName: "空腹のグロドット",
    image: {
      url: "/images/members/characters15.webp",
      name: "characters15.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
    },
  ...
  },
  {
    ...
    japaneseRace: "デュラハン",
    japaneseDescription: [
      "幼い頃からずっと馬を乗っていたニコラスは乗馬のない過去などは覚えていない。デュラハンのニコラスは人間の前世にでも馬を乗っていたと確信を持っている。頭が身体から外れると薄い光が首のところから光ってくる。よく自分の頭を左手で持って歩いている。",
      "競走馬を育てる農場で成長したおかげでニコラスは大の負けず嫌い、そして負けて悪びれない人だ。",
    ],
    japaneseHobbies: [
      "動物の面倒を見ること、特に馬みたいに大きい動物",
      "一日中頑張った後のお風呂の気持ちよさ",
      "ダーツ",
    ],
    japaneseEmployer: "オサリバン農場",
    japaneseJob: "騎手",
    japaneseName: "ニコラス・オサリバン",
    image: {
      url: "/images/members/characters16.webp",
      name: "characters16.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "20%",
  ...
  },
  {
    ...
    race: "Sea Monk",
    emoji: ["aryaIrritated", "seagullMad"],
    description: [
    ...
    hobbies: [
      ...
      "Making candles with various scents. Particularly using freshly picked herbs from the forest.",
      "Going on walks. Particularly by the ocean.",
      "Playing small handheld instruments like the ocarina, flute, miniature harp, the lute, and more.",
    ],
    japaneseRace: "シーモンク",
    japaneseDescription: [
      "デンマークにある小さな宗教的な村で生まれ育ったアルヤは子供の頃からずっと神様という存在を心の底から信じてきた。村から文化交流の代表として選ばれ、世間に歩み出た。",
      "教会の福音を世の中みんなに伝えたくて番組に出たという。自分と似たような信念を持っている人はかなり少ないとは分かっているが、いかにも人と人の結びや因縁には何かの深い意味があるのではないかと信じている。",
    ],
    japaneseHobbies: ["キャッチ＆リリースの釣り", "手作りのロウソク", "お散歩"],
    japaneseEmployer: "新新世界教会",
    japaneseJob: "司祭",
    japaneseName: "アルヤ・ジェンセン",
    image: {
      url: "/images/members/characters17.webp",
      name: "characters17.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
    },
  ...
  },
  {
    ...
    emoji: ["sejiAngry"],
    description: [
      `Seji is a mountain rock troll of the Toomin tribe, a nomadic tribe that moves from mountain to mountain. A primitive tribe that practices the belief of "simple living" and living without waste.`,
      `Seji moved to the city at a young age to study for and pass the bar exam. Seji always wanted to prove to the world that trolls are not as dumb as stereotypes would have you believe. Often wears glasses with a string strap for convenience—so as to have it ready at a moments notice.`,
    ],
    hobbies: [
    ...
    japaneseRace: "トロール",
    japaneseDescription: [
      "セジはいつも山から山へ流れていく山トロールのトゥーミン族に所属するものだ。",
      "若い時から勉強のため都市に引っ越した。世間にトロールは既成概念ほど頭が悪くないと証明したくて司法試験に受かった。普段の格好は糸付きの眼鏡をかけている。",
    ],
    japaneseHobbies: [
      "ただで訴訟事件を行うこと、特に山のトロールのために",
      "面白そうな訴訟事件について読むこと",
      "ロマンス系小説",
    ],
    japaneseEmployer: "WT&T法律事務所",
    japaneseJob: "弁護士",
    japaneseName: "セジ・トゥーミン",
    image: {
      url: "/images/members/characters18.webp",
      name: "characters18.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "35%",
  ...
  },
  {
    ...
    race: "Sentient Armor",
    description: [
      `“Dommy” was enchanted by a witch and brought to life many centuries ago. Countless knights have worn this armor and yet nothing is known about its origins. Thanks to the enchantment, Dommy can also speak many languages. Lost the left hand piece of the armor set a long time ago in a fierce battle.`,
      `Emancipated several decades ago due to the Sentient Object Protections Act (SOPA), “Dommy” is still desperately searching for the witch behind the enchantment. Came onto the show in hopes of finding any leads.`,
    ],
    hobbies: [
      "Scaring innocent people by pretending to be medieval decoration.",
      "Watching paint dry, grass grow, and ice melt. Anything that happens really slowly over a long period of time.",
      "Rubbing rust remover all over the armor, getting at all the nooks and crannies.",
      "Listening to brass instruments.",
    ],
    japaneseRace: "騎士の鎧",
    japaneseDescription: [
      "何１００年前、魔女に呪文をかかれて生き返ったハギちゃん。もう自分の由来や歴史は覚えていない。何数人の騎士や鬼に着られ何回も軍場や戦争に出たことがあるが、いままで生き残ったものは一人もいないらしい。",
      "何十年前にある有情物体保護法（SOPA）によって自由になったハギちゃんは未だに自分の由来や魔法をかけた魔女を探し続けている。",
    ],
    japaneseHobbies: [
      "じっとしては突然飛び出してびっくりさせること",
      "乾いている塗料をジーとみること",
      "体にサビ消しを塗ること",
    ],
    japaneseEmployer: "イコラン銀行",
    japaneseJob: "銀行の警備員",
    japaneseName: "覇業の鎧、ハギちゃん",
    image: {
      url: "/images/members/characters19.webp",
      name: "characters19.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "25%",
  ...
  },
  {
    ...
    japaneseRace: "ユニコーン",
    japaneseDescription: [
      "７人兄弟の中で末っ子のソゥ。長女とは１９年離れて、子供の時はいつも一人ぼっちで寂しく育った。起業家精神が強いけれど、他人とはあまり仲良く仕事できない。",
      "最近家族の印刷営業を受け取って自分なりに頑張っているが紙に印刷する需要がますます滅んでいくので、色々な方法で魔法の物にも印刷しようとしている。",
    ],
    japaneseHobbies: [
      "木版活字を集めること",
      "木版活字を撮ってカタログに載せること",
    ...
    japaneseEmployer: "ユニコーン印刷",
    japaneseJob: "印刷人",
    japaneseName: "ソゥ",
    image: {
      url: "/images/members/characters20.webp",
      name: "characters20.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
    },
  ...
  },
  {
    ...
    image: {
      url: "/images/members/characters21.webp",
      name: "characters21.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
    },
  ...
  },
  {
    ...
    employer: false,
    race: "Human",
    emoji: ["hansanSmoke", "magicFingers", "magicFist", "magicOkay"],
    description: [
    ...
    japaneseRace: "人間",
    japaneseDescription: [
      "あの名門のドゥマース魔術学園から卒業。自分のアトリエで魔法でしか解けないコンサルティングサービスを行なっている。ポーションは苦手だが、呪文は好き。",
      "魔法で仕事してない場合は木工芸もやっている。自分の両手で物を作り出すことが好き。",
    ],
    japaneseHobbies: ["木工芸", "木を削る", "大工仕事"],
    japaneseEmployer: false,
    japaneseJob: "魔法使い",
    japaneseName: "ハンサン・スネッカー",
    image: {
      url: "/images/members/characters22.webp",
      name: "characters22.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "60%",
  ...
  },
  {
    ...
    hobbies: [
      "Painting using clashing bold strokes of vibrant colors. Making a statement using art.",
      "Making art by drawing shapes in a complex sequence or pattern.",
      "Crochet as a hobby. Watching videos of complex crochet patterns.",
      "Really likes rubber ducks.",
      "Pottery.",
    ],
    japaneseRace: "バイコーン",
    japaneseDescription: [
      "フランスの西側生まれだが、幼い時色々な国に移民したせいで多数の言語が出来る。バイコーンについてはあまり知られてないのでどこに行ってもよく怖がられる。そういう変な噂を溶けるために番組に出たセレスチアはバイコーンのイメージを改善したいようだ。",
      "アートやお絵描きが好きで、以前モデルの道も考えたこともあるが、結局大手会社をやめフリーランスイラストレーターとして頑張ろうと決めた。",
    ],
    japaneseHobbies: [
      "カラオケ、特にいろんな言語に訳された曲",
      "いろんな形を組み合わせて複雑な模様を描くこと",
      "ランニング",
    ],
    japaneseEmployer: false,
    japaneseJob: "美術家",
    ...
    image: {
      url: "/images/members/characters23.webp",
      name: "characters23.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "85%",
  ...
  },
  {
    ...
    urlName: "dimakostwins",
    age: 25,
    job: "Freelance Artist",
    employer: "Self-employed",
    job2: "Accountant",
    employer2: "Better Calculations Business",
    race: "Gemini",
    emoji: ["eliasAndMaya"],
    description: [
    ...
    japaneseRace: "ジェミニ",
    japaneseDescription: [
      "双児宮は一体の身体に脳が二つ。お互い何を考えているが分かる。基本的に双児宮の性格にはあまり差がないが、稀にすごく異なる性格を持つ双児宮もいる。",
      "エリアスは自発的でクリエーティブな人、マヤは打算的で未来遠くまで計画を経つのが好き。二人はとても中良くてお似合いの双児宮で、週に一回ポッドキャストの司会を行って、いろいろな獣の悩みの相談を受けている。",
    ],
    japaneseHobbies: [
      "アートや動画を作ること（エリアス）",
      "謎やパズルを解けること（マヤ）",
    ...
    japaneseEmployer: "良質計算会計事務所",
    japaneseJob: "会計士 / フリーランスアーティスト",
    japaneseName: "エリアス＆マヤ・ディマコス",
    image: {
      url: "/images/members/characters24.webp",
      name: "characters24.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "35%",
  ...
  },
  {
    ...
    japaneseHobbies: ["人間観察", "雨のなかに座ること", "野生キャンプ"],
    japaneseEmployer: "株式会社オニックス建設",
    japaneseJob: "建設労働者",
    japaneseName: "巨人のスソム",
    image: {
      url: "/images/members/characters25.webp",
      name: "characters25.webp",
      width: 2000,
      height: 1200,
      credit: "https://www.fiverr.com/carolynfrank",
      objectPosition: "65%",
...
export function getSpecificPersonByURL(urlName) {
  ...
  for (let i = 0; i < allCharacters.length; i++) {
    if (allCharacters[i].urlName === urlName) {
      ...
      let nextIndex =
        i + 1 >= allCharacters.length ? allCharacters.length - 1 : i + 1;
      return {
        ...allCharacters[i],
        index: i + 1,
        total: allCharacters.length,
        prevCharURL:
          allCharacters[prevIndex].ignoreInRandom || i === prevIndex
            ? false
            : allCharacters[prevIndex].urlName,
        nextCharURL:
          allCharacters[nextIndex].ignoreInRandom || i === nextIndex
            ? false
            : allCharacters[nextIndex].urlName,
      };
    }
  }
