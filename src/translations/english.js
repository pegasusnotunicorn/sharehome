  ...
  translation: {
    ...
    "main page":{
      ...
      "description": {
        ...
        "subtitle3": "Play as a mythological creature in a reality TV show, complete chaotic character arcs and achieve high ratings for the season!",
      ...
      "character": {
        ...
        "click me": "CLICK ME",
        "moretocome": "Mythological creatures with modern day jobs just like us humans.",
        "clicktoseemore" : "View all characters",
      },
      "events": {
        "description": "Follow directions in a race against the clock!",
        "subdescription": "The producer's of the show are trying to instill a little chaos into the plot. Fulfill as many of their Direction Cards as you can to earn more points!",
      },
      "goals": {
        "description": "Chaotic locations for chaotic episodes.",
        "subdescription": "Every episode of the reality TV show occurs in a random exotic location carefully hand-picked for maximum excitement!",
      },
      "likehate": {
        "description1": "Complete character arcs for extra points!",
        "like": "likes",
        "hate": "hates",
        "description2": "Will you have the evil villain arc? Or the good person redemption arc?",
      },
      "mechanics": {
    ...
    "about page":{
      ...
      "roleplay":{
        "name": "Roleplay",
        "description": "You are a mythological creature in a reality TV show. The producers of the show are trying to instill some chaos into the narrative. Try to fulfill as many of their directions as you can in a race against the clock!",
        ...
        "setup":{
          ...
          "step1": "Step 1",
          "step1m 1": "Each player is given a random Character Card and three random Character Traits.",
          "step1m 2": "The goal of the game is to score points. The higher you score, the better the ratings will be for your season. Fulfill as many Direction Cards as you can as a group and complete your Character Arcs to earn points.",
          "step1m 3": "Place your Character Card in the plastic card standee for all to see.",
          "step1m 4": "For Character Traits, every player receives one of each color at random.",
          "step1m 5": "Form your Character Arc by rearranging the order of your Character Traits.",
          "step2 1": "Place the Episode Cards, Direction Cards, and Point Tokens in the center of the table.",
          "step2 2": "Every player must be able to read the cards clearly so please sit accordingly.",
          "step2 3": "Place a phone in clear view of everyone and set a timer for 3 minutes.",
          "step2 4": "Split the Direction Cards into two decks according to their point values.",
          "step3 1": "Starting with the oldest Character, all players introduce themselves.",
          "step3 2": "Feel free to omit or replace any of the written character details as you see fit.",
          "step3 3": "Make sure to also mention your Character Arc so others are aware of it.",
          "step3 4": "Remember, this is your reality TV show debut!",
          "step3 5": "Continue clockwise until all players have introduced themselves.",
        ...
        "rules":{
          ...
          "step1": "Episode Cards",
          "step1 1": "Flip over an Episode Card. This will be the location for Episode One.",
          ...
          "step2 1": "Flip over three cards from both Direction Card decks. Six total cards should be face up at all times.",
          "step2 2": "The producers of the show are trying to instill a little chaos into the plot!",
          "step2 3": "In three minutes, complete as many Direction Cards as you can as a group.",
          "step2 4": "Each Direction Card is worth one or two points.",
          "step2 5": "Replenish a card as soon as you complete it.",

          "step3": "Point Tokens",
          "step3 1": "Point tokens can be used to earn extra points during the game.",
          "step3 2": "Anytime someone references something from a previous episode, place a Point Token on that Episode Card to earn an extra point.",
          "step3 3": "Just because someone else completed a Direction Card before you had a chance to speak, does not mean you lost your chance. Place a Point Token on the current Episode Card to earn an extra point and say what you wanted to say.",
