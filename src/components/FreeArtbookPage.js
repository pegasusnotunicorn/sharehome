    ...
    <div className="content max-width">
      ...
      <div className="subcontentWrapper">
        <div className="couchContainer">
          <img className="couch" style={{width:"100%"}} src="/images/artbook/small_mockup2.jpg" alt={t('free artbook page.description')}></img>
          <img className="couch" style={{width:"100%"}} src="/images/artbook/small_mockup1.jpg" alt={t('free artbook page.description')}></img>
